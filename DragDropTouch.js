...
(function (DragDropTouch_1) {
    ...
    DragDropTouch._PRESSHOLDAWAIT = 250; // ms to wait before press & hold is detected
    DragDropTouch._PRESSHOLDMARGIN = 100; // pixels that finger might shiver while pressing
    DragDropTouch._PRESSHOLDTHRESHOLD = 0; // pixels to move before drag starts
    DragDropTouch._flag = true;
